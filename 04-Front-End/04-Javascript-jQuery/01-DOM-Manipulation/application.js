...
function run_challenges() {
  ...
  $("#email").val("melanie.navarro.pro@gmail.com");



  // Ex 3. Replace the email hint (next to the input) with 'This is my email now'
  //       The text should be emphasized using a <strong> tag
  var new_email = $('#email-hint').html('<strong>This is my email now</strong>');
  ...
  $('tbody').append("<tr><td>15</td><td>toto</td><td>0</td></tr></tbody>")

  // Ex 7. Write some code to sum all points given to all teams
  var sum = 0;  // TODO: replace 0 with your sum result, keep the sum variable.
  $('tbody tr td:nth-child(3)').each(function(index, element){ sum += parseInt($(element).text());})
